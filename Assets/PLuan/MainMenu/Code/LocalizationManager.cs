...
public static class LocalizationManager
{
    ...
    private static readonly Dictionary<Language, Dictionary<string, string>> _localizedText = new Dictionary<Language, Dictionary<string, string>>
    {
        [Language.English] = new Dictionary<string, string>
        {
            ...
            ["lbl_opt_mic_device"] = "MICROPHONE DEVICE",
            ["lbl_opt_mic_mode"] = "TRANSMISSION MODE",
            ["lbl_mic_input_vol"] = "MIC INPUT VOLUME",
            ["lbl_voice_playback_vol"] = "PLAYER VOICE VOLUME",
            ["mic_mode_ptt"] = "Push To Talk",
            ["mic_mode_auto"] = "Auto (Voice Active)",
            ["lbl_opt_output_device"] = "OUTPUT DEVICE",
            ["lbl_ptt_key"] = "PUSH TO TALK KEY",
            ["btn_players_voice"] = "PLAYERS VOICE",
            ...
            ["lbl_antialiasing"]   = "ANTI-ALIASING",
            ["lbl_shadow_quality"] = "SHADOW QUALITY",
            ["lbl_particle_quality"] = "PARTICLE QUALITY",
            ["lbl_fps_cap"]        = "FRAME RATE CAP",
            ["lbl_post_fx"]        = "POST-PROCESSING EFFECTS",
            ["aa_off"]  = "Off",
            ["aa_2x"]   = "MSAA 2x",
            ["aa_4x"]   = "MSAA 4x",
            ["aa_8x"]   = "MSAA 8x",
            ...
            ["shadow_high"]   = "High",
            ["particles_low"]    = "Low",
            ["particles_medium"] = "Medium",
            ["particles_high"]   = "High",
            ["fps_uncapped"] = "Unlimited",
            ["fps_30"]       = "30 FPS",
            ["fps_60"]       = "60 FPS",
            ["fps_120"]      = "120 FPS",
            ["fps_144"]      = "144 FPS",
        ...
        [Language.Vietnamese] = new Dictionary<string, string>
        {
            ...
            ["lbl_opt_mic_device"] = "THIẾT BỊ MICRO",
            ["lbl_opt_mic_mode"] = "CHẾ ĐỘ TRUYỀN THÔNG TIN",
            ["lbl_mic_input_vol"] = "ÂM LƯỢNG THU (MICRO)",
            ["lbl_voice_playback_vol"] = "ÂM LƯỢNG NGƯỜI CHƠI KHÁC",
            ["mic_mode_ptt"] = "Nhấn để nói",
            ["mic_mode_auto"] = "Tự động phát hiện",
            ["lbl_opt_output_device"] = "THIẾT BỊ ĐẦU RA",
            ["lbl_ptt_key"] = "PHÍM NHẤN ĐỂ NÓI",
            ["btn_players_voice"] = "ÂM THANH LOBBY",
            ...
            // Graphics sub-options
            ["lbl_antialiasing"]   = "KHỬ RĂNG CƯA",
            ["lbl_shadow_quality"] = "CHẤT LƯỢNG BÓNG ĐỔ",
            ["lbl_particle_quality"] = "CHẤT LƯỢNG HẠT",
            ["lbl_fps_cap"]        = "GIỚI HẠN FPS",
            ["lbl_post_fx"]        = "HIỆU ỨNG HẬU KỲ",
            ["aa_off"]  = "Tắt",
            ["aa_2x"]   = "MSAA 2x",
            ["aa_4x"]   = "MSAA 4x",
            ["aa_8x"]   = "MSAA 8x",
            ["shadow_off"]    = "Tắt",
            ["shadow_low"]    = "Thấp",
            ["shadow_medium"] = "Trung bình",
            ["shadow_high"]   = "Cao",
            ["particles_low"]    = "Thấp",
            ["particles_medium"] = "Trung bình",
            ["particles_high"]   = "Cao",
            ["fps_uncapped"] = "Không giới hạn",
            ["fps_30"]       = "30 FPS",
            ["fps_60"]       = "60 FPS",
            ["fps_120"]      = "120 FPS",
            ["fps_144"]      = "144 FPS",
            ...
            ["hud_stat_hp"] = "MÁU",
            ["hud_stat_mp"] = "NĂNG LƯỢNG",
            ["hud_stat_cooldown"] = "HỒI CHIÊU",
            ["hud_stat_damage"] = "SÁT THƯƠNG",
            ["hud_stat_speed"] = "TỐC ĐỘ CHẠY",
            ["hud_upgrade_lv_hp"] = "Lv. {0} (+{1} HP)",
            ["hud_upgrade_lv_mp"] = "Lv. {0} (+{1} N.Lượng)",
            ["hud_upgrade_lv_cooldown"] = "Lv. {0} (-{1}s)",
            ["hud_upgrade_lv_damage"] = "Lv. {0} (+{1} S.Thương)",
            ["hud_upgrade_lv_speed"] = "Lv. {0} (+{1} T.Độ)",
