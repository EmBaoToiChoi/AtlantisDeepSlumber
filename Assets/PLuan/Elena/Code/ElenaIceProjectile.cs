...
public class ElenaIceProjectile : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log($"[ElenaIceProjectile] Đạn băng được khởi tạo tại: {transform.position}, góc xoay: {transform.rotation.eulerAngles}, Tag: {gameObject.tag}");
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log($"[ElenaIceProjectile] Đạn băng va chạm trúng chướng ngại vật: {other.name}, tự hủy.");
            DespawnOrDestroy();
        }
    }
