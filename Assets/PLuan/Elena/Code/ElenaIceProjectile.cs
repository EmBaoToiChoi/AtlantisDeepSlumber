...
public class ElenaIceProjectile : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        if (rb == null)
        {
            ...
            Debug.Log("[ElenaIceProjectile] Đã tự động thêm Rigidbody ở chế độ Kinematic để bắt va chạm tĩnh.");
        }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (isEnemy)
        {
            ...
            Debug.Log($"[ElenaIceProjectile] Đạn băng va chạm trúng Enemy/Boss: {other.name}, Gây sát thương: {damage}");
