...
4. We will also build a dungeon map as an example. 
...
9. Rebake light at scene at resolution 9  or higher, we have to reduce because of pack size at asset store.
