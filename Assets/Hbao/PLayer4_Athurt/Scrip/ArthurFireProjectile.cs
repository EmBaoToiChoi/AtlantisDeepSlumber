...
public class ArthurFireProjectile : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log($"[ArthurFireProjectile] Cục lửa được khởi tạo tại: {transform.position}, góc xoay: {transform.rotation.eulerAngles}, Tag: {gameObject.tag}");
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        // Bỏ qua va chạm với bất kỳ đối tượng Player nào (bao gồm Arthur, Elena, Leo, Maya, SimplePlayerTest)
        ...
        if (isEnemy)
        {
            ...
            Debug.Log($"[ArthurFireProjectile] Cục lửa va chạm trúng Enemy: {other.name}, Gây sát thương: {damage}");
        ...
        {
            Debug.Log($"[ArthurFireProjectile] Cục lửa va chạm trúng chướng ngại vật: {other.name}, tự hủy.");
            DespawnOrDestroy();
        }
    }
