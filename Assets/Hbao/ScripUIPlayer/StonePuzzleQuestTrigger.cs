...
public class StonePuzzleQuestTrigger : NetworkBehaviour
{
        ...
        if (localHudCtl != null)
        {
            ...
            if (shouldShow)
            {
                ...
                if (pressedCount != lastPressedCount)
                {
                    ...
                    localHudCtl.UpdateQuestProgress(pressedCount, totalCount);
    ...
    private void CompleteQuest()
    {
        ...
        if (localHudCtl != null)
        {
            ...
            localHudCtl.ShowQuest(true);
            localHudCtl.UpdateQuestProgress(totalCount, totalCount);
            localHudCtl.UpdateQuestDescription("Nhiệm vụ hoàn thành: Cửa đã được mở!");
            localHudCtl.UpdateQuestTitle(questTitle);
            localHudCtl.UpdateQuestIcon(questIconSprite);
