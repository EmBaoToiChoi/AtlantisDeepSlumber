...
{
    public bool IsQuestCompleted => (SaveManager.IsContinueMode && SaveManager.IsQuestCompleted("FinalBossQuest")) || 
        ((NetworkManager.Singleton != null && NetworkManager.Singleton.IsListening) ? isQuestCompletedNet.Value : isQuestCompletedLocal);

    public bool IsQuestActive => !(SaveManager.IsContinueMode && SaveManager.IsQuestCompleted("FinalBossQuest")) && 
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (SaveManager.IsContinueMode && SaveManager.IsQuestCompleted("FinalBossQuest"))
        {
            ...
            if (finalBoss != null) finalBoss.gameObject.SetActive(false);
            if (IsServer)
            {
